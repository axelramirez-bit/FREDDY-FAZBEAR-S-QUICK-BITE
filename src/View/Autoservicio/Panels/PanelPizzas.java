...
/**
 * Catálogo de la categoría "Pizzas" (solo "Pizza Party Personal",
 * separada de "Almuerzos y Cenas" — ver
 * sp_migrar_categorias_hamburguesas_pizzas en FreddyQuickBite.sql,
 * o migracion_categorias_hamburguesas_pizzas.sql si ya tienes datos
 * y no quieres recrear la base).
